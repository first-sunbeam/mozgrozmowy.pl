		...
		groups: [
			{
				...
				items: [
					...
					{
						title:
							"Mózg na terapii: co się dzieje w środku, gdy terapeuta zadaje pytanie?",
			...
			},
			{
				...
				items: [
					...
					{
						title:
							"Wykluczenie przez konstrukcję pomocy – esej o tragedii z Poznania",
		...
		groups: [
			...
			},
			{
				...
				items: [
					...
					{
						title:
							"Excluded by the Construction of Support – an Essay on the Poznań Tragedy",
