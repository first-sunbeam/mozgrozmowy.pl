...
# Wykluczenie przez konstrukcję pomocy – esej

Stowarzyszeniem odkąd powstało, ponad 30 lat temu.

Esej Małgosi Mikołajczyk, w którym autorka próbuje „opisać przepaść, która wciąż dzieli dwa światy: osób z niepełnosprawnościami i tych, których ten temat nie dotyczy (...) Dla większości społeczeństwa rzeczywistość opiekunów pozostaje abstrakcyjna, a tragedie tego typu zawsze będą zaskakiwać”.
...
## 1️⃣ Psychologiczny wymiar sytuacji
...
## 2️⃣ Kontekst systemowy i błędna percepcja społeczna
...
## 3️⃣ Co ujawnia oświadczenie - z perspektywy spoza „bańki” opiekunów osób z niepełnosprawnością
...
## 4️⃣ Dlaczego większość społeczeństwa tego nie rozumie
...
## 5️⃣ Strukturalne źródło kryzysu: mylenie pojęć
