...
topics: ["autism", "ASD", "psychotherapy", "neurodivergence", "overload", "communication"]
published: true
featured: false
...
**Therapy:** offers emotions, emotional attunement, intuition.  
...
And what I feel is this: I am falling apart.

I cannot pretend I do not need support.
...
And I am simply not built from the same material as the therapeutic system.
...
This is real help for me. Everything else — even when well-intentioned — deepens my overload.
...
But the fact that I do not experience emotions in a way that is legible to others does not mean that I do not have them.
...
And perhaps there is trauma in that too. But that is not all.  
It is also the architecture of my mind.

I no longer want every difficulty I have to be treated as a symptom. Sometimes “I don't feel” because the system knows that this is not its path to survival.
