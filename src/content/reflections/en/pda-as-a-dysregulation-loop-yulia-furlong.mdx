...
topics: ["PDA", "autism", "ASD", "regulation", "stress", "co-regulation"]
published: true
featured: false
...
Amygdala hyperreactivity works like an overly sensitive smoke detector — the alarm goes off in response to signals that are not objectively dangerous, such as an ordinary request or demand.
